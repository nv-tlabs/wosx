...
struct RobinLineSegmentBound {
    ...
    static void computeSquaredStarRadiusBound(BoundingSphere<2>& s, float maxRobinCoeff,
        ...
        if (h > 0.0f) {
            ...
            float cosLine = std::sqrt(h*maxRobinCoeff)/WOSX_SQRT_2;
    ...
    static void computeSquaredStarRadiusBound(BoundingSphere<3>& s, float maxRobinCoeff,
        ...
        if (h > 0.0f) {
            ...
            if (maxCosForBound >= cosLowerBound) {
                float cosPlane = maxCosForBound/WOSX_SQRT_3;
...
void RobinLineSegmentBound::computeSquaredStarRadiusBound(const enokiVector2& sc, FloatP<WIDTH>& r2, const FloatP<WIDTH>& maxRobinCoeff,
    ...
    FloatP<WIDTH> cosLine = enoki::sqrt(hMaxRobinCoeff)/WOSX_SQRT_2;
...
void RobinTriangleBound::computeSquaredStarRadiusBound(const enokiVector3& sc, FloatP<WIDTH>& r2, const FloatP<WIDTH>& maxRobinCoeff,
    ...
    FloatP<WIDTH> cosPlane = maxCosForBound/WOSX_SQRT_3;
